...
""",
    ...
    parser.add_argument("--config-file", default="/home/niudt/u2seg_eff/detectron2/configs/COCO-PanopticSegmentation/efficiency_1per.yaml", metavar="FILE", help="path to config file")
    parser.add_argument(
        "--resume",
        default=True,
        action="store_true",
